...
## Backdrop
I still remember that Saturday vividly. I was at the Data Day conference in Austin when an unexpected SVP call changed everything. A complex, multi-million-dollar migration was deep red, and the CIO had decided to replace its leadership. My name had come up. By Monday, after a few more SVP discussions and an “inspiring” chat with the CIO, I found myself leading the Data Platform and Engineering teams for the company. My primary objective: Rescue the project.

## The Framework: Two's a Company

The CIO leadership team had thought it through. Along with the need for a total revamp of the product line, they also noticed a material weakness in technical program management. So they assigned a senior Technical Program Manager, Sam Wingo, to partner with me. This was a brilliant call: besides ensuring the technical aspects were sound, the program desperately needed structure and clarity on measurable progress.
...
Given the late stage this project was in, it needed exactly this combination. While a two-in-a-box approach at project inception might easily pair a product leader with an engineering leader, this project required the TPM/Tech combo to provide the structural rigor that had been missing.

![regular](images/sam-and-i-2.png)

This was a team of equals with no egos. We both knew there wasn't much time and every hour counted. For that purpose, we were always talking or texting adhoc, discussing issues as they came up. We would spend time preparing for major meetings, or discuss approaches to talk to certain stakeholder personalities, or sometimes just to vent to each other!
...
### Key skills needed in a TPM for projects like these
...
Sam brought something our project desperately needed: the Winston Wolf mentality (A nod to Pulp Fiction)
...
Sam was the perfect complement to my technical leadership because he brought the discipline that our project had been missing. While I focused on the engineering challenges, he ensured we had a plan that people actually followed - and the authority to make them follow it.

## Mindset

![regular](images/mindset.png)

At the heart of any turnaround lie three essential shifts in how you think: first, a rock-solid belief that success is the only option; second, a deliberate choice to cultivate the state of being—curious, alert, positive—that makes each action precise and effective; and third, the willingness to treat looming deadlines as a source of focus and energy rather than a cause for panic. These shifts form the foundation for everything that follows.
...
During our project, I learned that I needed to be intentional about being curious rather than defensive, being positive rather than reactive, being expansive rather than constrained. When I operated from these states of being, I found that the actions I executed had a degree of quality, intensity, and efficacy that would otherwise not be there.
...
## Forensic Analysis
Before you jump in and start executing, it’s always a good idea to step back to a hill close by and survey the battlegrounds.

This gives you a clear vantage from which to formulate your strategy and avoid repeating past mistakes. In this section you will:

- Conduct a Project Assessment, determining how much runway remains—quarters or months—and shaping your high-level battle plan.
- Perform a Team Assessment, sizing up the skills, capacity, and morale of the people who will carry your strategy into action.
- Take a moment to pinpoint the inflection point, identifying the specific event or signal that prompted leadership to declare the project in crisis.

Let's expand these topics:

### Project Assessment

How much time you have dictates your strategy: 2 quarters or 2 months?

In red projects you seldom have a year or more than 2 quarters as it's already too late and the project is red. You are the ER doctor going in trying to save the patient's life.
...
Here's the thing: at work, you can spot leaders who understand level 1 of an issue but when pressed for details, their limited grasp of the full problem and its impact becomes evident. In your project, you can't afford to run your ship with partial understanding - that's likely what got the project into this state in the first place.
...
By that point the team was exhausted, worn down by back-to-back quarters of firefighting and the belief that nothing would ever improve. Their shoulders slumped in meetings and every conversation carried a quietly defeated tone. Morale had become the biggest barrier to progress.
Recalibration was needed on multiple levels. First, bringing positivity and the "we will succeed" mindset into their thinking and approach. This had to be grounded in real changes they could see and feel. Second, leading by example by constantly asking "what else can I do" to make this faster and better, rather than waiting for others to step up. And third, pivoting the teams to focus on critical items first, giving them a clear sense of priority and progress.
The challenge with demoralized teams is that they've often been burned before by promises that didn't materialize. They've seen new leadership come in with grand plans, only to hit the same walls that defeated the previous leadership. So you can't just tell them things will be different. Instead, you have to show them through your actions.
...
My experience in turning around projects is that you're rewarded by your leadership in the end in some monetary way. Whenever I receive it, I typically just put that money right in her hands. She earned it more than I did.
...
I had alluded to the important of mindset earlier on. I want to bring another dimension here. Compartmentalization. In hard-charging executive roles, I marvel at senior leaders who can compartmentalize the work craziness and put it aside to have restful sleep. My dad was like that in his working days. The way I look at it, every single time such a project comes my way, it gives me ample opportunity to practice "compartmentalization." If I was a librarian, when would I ever get to work on my emotional regulation?
...
I remember the last steering call we had on this project. The cutover was completed, the older system was getting ready to be physically decommissioned, and the CIO got on the call. He was literally at a loss for words. He said he really thought we were not going to be able to make it, and he just couldn't express his amazement. His voice cracked slightly as he spoke. This was a leader who had seen it all, but even he was moved by what we had pulled off together.
